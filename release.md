...
En sak jag funderat över, är att det eventuellt kommer behövas lägga till en annan metod för datahämtning eller inmatning. Detta då den ska kunna få data direkt via en annan app.
